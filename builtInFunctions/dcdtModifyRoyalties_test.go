...
func TestNewDCDTModifyRoyaltiesFunc(t *testing.T) {
	t.Parallel()

	t.Run("nil accounts adapter", func(t *testing.T) {
		t.Parallel()

		e, err := NewDCDTModifyRoyaltiesFunc(0, nil, nil, nil, nil, nil, nil)
		assert.Nil(t, e)
	...
	t.Run("nil global settings handler", func(t *testing.T) {
		...
		e, err := NewDCDTModifyRoyaltiesFunc(0, &mock.AccountsStub{}, nil, nil, nil, nil, nil)
		assert.Nil(t, e)
	...
	t.Run("nil enable epochs handler", func(t *testing.T) {
		...
		e, err := NewDCDTModifyRoyaltiesFunc(0, &mock.AccountsStub{}, &mock.GlobalSettingsHandlerStub{}, nil, nil, nil, nil)
		assert.Nil(t, e)
	...
	t.Run("nil storage handler", func(t *testing.T) {
		...
		e, err := NewDCDTModifyRoyaltiesFunc(0, &mock.AccountsStub{}, &mock.GlobalSettingsHandlerStub{}, nil, nil, &mock.EnableEpochsHandlerStub{}, nil)
		assert.Nil(t, e)
	...
	t.Run("nil roles handler", func(t *testing.T) {
		...
		e, err := NewDCDTModifyRoyaltiesFunc(0, &mock.AccountsStub{}, &mock.GlobalSettingsHandlerStub{}, &mock.DCDTNFTStorageHandlerStub{}, nil, &mock.EnableEpochsHandlerStub{}, nil)
		assert.Nil(t, e)
	...
	t.Run("nil marshaller", func(t *testing.T) {
		...
		e, err := NewDCDTModifyRoyaltiesFunc(funcGasCost, &mock.AccountsStub{}, &mock.GlobalSettingsHandlerStub{}, &mock.DCDTNFTStorageHandlerStub{}, &mock.DCDTRoleHandlerStub{}, &mock.EnableEpochsHandlerStub{}, nil)
		assert.Nil(t, e)
	...
	t.Run("should work", func(t *testing.T) {
		...
		funcGasCost := uint64(10)
		e, err := NewDCDTModifyRoyaltiesFunc(funcGasCost, &mock.AccountsStub{}, &mock.GlobalSettingsHandlerStub{}, &mock.DCDTNFTStorageHandlerStub{}, &mock.DCDTRoleHandlerStub{}, &mock.EnableEpochsHandlerStub{}, &mock.MarshalizerMock{})
		assert.NotNil(t, e)
		assert.Nil(t, err)
...
func TestDCDTModifyRoyalties_ProcessBuiltinFunction(t *testing.T) {
	t.Parallel()

	t.Run("nil vmInput", func(t *testing.T) {
		t.Parallel()

		e, _ := NewDCDTModifyRoyaltiesFunc(0, &mock.AccountsStub{}, &mock.GlobalSettingsHandlerStub{}, &mock.DCDTNFTStorageHandlerStub{}, &mock.DCDTRoleHandlerStub{}, &mock.EnableEpochsHandlerStub{}, &mock.MarshalizerMock{})
	...
	t.Run("built-in function is not active", func(t *testing.T) {
		...
		e, _ := NewDCDTModifyRoyaltiesFunc(0, &mock.AccountsStub{}, &mock.GlobalSettingsHandlerStub{}, &mock.DCDTNFTStorageHandlerStub{}, &mock.DCDTRoleHandlerStub{}, enableEpochsHandler, &mock.MarshalizerMock{})
		vmInput := &vmcommon.ContractCallInput{
			VMInput: vmcommon.VMInput{
				CallValue:  big.NewInt(0),
				CallerAddr: []byte("caller"),
	...
	t.Run("check allowed to execute failed", func(t *testing.T) {
		...
		e, _ := NewDCDTModifyRoyaltiesFunc(0, &mock.AccountsStub{}, &mock.GlobalSettingsHandlerStub{}, &mock.DCDTNFTStorageHandlerStub{}, rolesHandler, enableEpochsHandler, &mock.MarshalizerMock{})
		vmInput := &vmcommon.ContractCallInput{
			VMInput: vmcommon.VMInput{
				CallValue:  big.NewInt(0),
				CallerAddr: []byte("caller"),
	...
	t.Run("only changes the royalties", func(t *testing.T) {
		...
		storageHandler := &mock.DCDTNFTStorageHandlerStub{
			...
			SaveDCDTNFTTokenCalled: func(senderAddress []byte, acnt vmcommon.UserAccountHandler, tokenKey []byte, n uint64, dcdtData *dcdt.DCDigitalToken, properties vmcommon.NftSaveArgs) ([]byte, error) {
				...
				assert.Equal(t, uint32(50), dcdtData.TokenMetaData.Royalties)
		...
		e, _ := NewDCDTModifyRoyaltiesFunc(101, accounts, globalSettingsHandler, storageHandler, &mock.DCDTRoleHandlerStub{}, enableEpochsHandler, &mock.MarshalizerMock{})
...
func TestDCDTModifyRoyalties_SetNewGasConfig(t *testing.T) {
	t.Parallel()
	...
	newGasCost := &vmcommon.GasCost{
		BuiltInCost: vmcommon.BuiltInCost{
			DCDTModifyRoyalties: 10,
		},
	}
	e.SetNewGasConfig(newGasCost)

	assert.Equal(t, newGasCost.BuiltInCost.DCDTModifyRoyalties, e.funcGasCost)
}
