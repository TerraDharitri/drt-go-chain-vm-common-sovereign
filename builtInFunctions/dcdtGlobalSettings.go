...
func (e *dcdtGlobalSettings) ProcessBuiltinFunction(
	...
	err = e.toggleSetting(dcdtTokenKey, systemSCAccount)
	if err != nil {
		return nil, err
	}
...
func (e *dcdtGlobalSettings) toggleSetting(dcdtTokenKey []byte, systemSCAccount vmcommon.UserAccountHandler) error {
	dcdtMetaData, err := e.getGlobalMetadataFromAccount(dcdtTokenKey, systemSCAccount)
	if err != nil {
		return err
	}
...
func (e *dcdtGlobalSettings) GetGlobalMetadata(dcdtTokenKey []byte) (*DCDTGlobalMetadata, error) {
	...
	return e.getGlobalMetadataFromAccount(dcdtTokenKey, systemSCAccount)
}

func (e *dcdtGlobalSettings) getGlobalMetadataFromAccount(
	dcdtTokenKey []byte,
	systemSCAccount vmcommon.UserAccountHandler,
) (*DCDTGlobalMetadata, error) {
...
func (e *dcdtGlobalSettings) SetTokenType(
	dcdtTokenKey []byte,
	tokenType uint32,
