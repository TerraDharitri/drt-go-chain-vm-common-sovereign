...
// REWAIdentifier represents the identifier for the REWA in case of a transfer with MultIDCDTNFTTransfer built-in function
const REWAIdentifier = "REWA-000000"
