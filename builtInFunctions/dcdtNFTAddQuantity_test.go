...
func TestDcdtNFTAddQuantity_ProcessBuiltinFunctionShouldErrOnSaveBecauseTokenIsPaused(t *testing.T) {
	...
	eqf, _ := NewDCDTNFTAddQuantityFunc(10, createNewDCDTDataStorageHandlerWithArgs(globalSettingsHandler, &mock.AccountsStub{}, enableEpochsHandler, &mock.CrossChainTokenCheckerMock{}), globalSettingsHandler, &mock.DCDTRoleHandlerStub{}, enableEpochsHandler)
