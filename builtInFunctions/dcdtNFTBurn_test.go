...
func TestDcdtNFTBurnFunc_ProcessBuiltinFunctionShouldErrOnSaveBecauseTokenIsPaused(t *testing.T) {
	...
	ebf, _ := NewDCDTNFTBurnFunc(10, createNewDCDTDataStorageHandlerWithArgs(globalSettingsHandler, &mock.AccountsStub{}, &mock.EnableEpochsHandlerStub{}, &mock.CrossChainTokenCheckerMock{}), globalSettingsHandler, &mock.DCDTRoleHandlerStub{})
