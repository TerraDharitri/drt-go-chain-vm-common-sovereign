...
func getCrossChainActions() map[string]struct{} {
	...
	actions[core.DCDTRoleLocalMint] = struct{}{}
	actions[core.DCDTRoleNFTAddQuantity] = struct{}{}
	actions[core.DCDTRoleNFTCreate] = struct{}{}
	actions[core.DCDTRoleLocalBurn] = struct{}{}
	actions[core.DCDTRoleNFTBurn] = struct{}{}
...
func (e *dcdtRoles) isAllowedToExecuteCrossChain(address []byte, tokenID []byte, action []byte) bool {
